...
## 2.2.1.5 UNO与ESP01-S模块的通信

① ESP01-S模块烧录了代码后我们将为UNO烧录匹配控制的代码，打开`2.2.1 控制LED灯代码`文件夹中的"UNO代码"文件夹然后打开`WiFi_Control_LED.ino`程序选择开发板为“Arduino UNO”。
